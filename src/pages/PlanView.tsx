                ...
                <div key={j} className="group/tiempo p-4 bg-[#181818] rounded-[8px] border border-[#2a2a2a]">
                  ...
                  {((t as any).bebida || (t as any).suplTiempo) && (
                    <div className="flex flex-col gap-1 mt-3 pt-3 border-t border-[#2a2a2a]">
                      {(t as any).bebida && (
                        <p className="text-[11px] text-[#3a9eff] flex items-center gap-1.5 m-0">
                          <span className="font-bold">Bebida:</span>{(t as any).bebida}
                        </p>
                      )}
                      {(t as any).suplTiempo && (
                        <p className="text-[11px] text-[#a97fff] flex items-center gap-1.5 m-0">
                          <span className="font-bold">Suplementación:</span>{(t as any).suplTiempo}
                        </p>
                      )}
                    </div>
                  )}
                  {(t as any).suplNotas && (
                    <div className="mt-2 p-3 bg-[#0a0a0a] rounded-[6px] border border-[#2a2a2a]">
                      <p className="text-[10px] font-black text-[#555] uppercase tracking-widest mb-1">Suplementos / Notas</p>
                      <p className="text-[13px] font-normal text-[#8a8a8a] m-0 whitespace-pre-line">{(t as any).suplNotas}</p>
                    </div>
                  )}
                </div>
              ))}
